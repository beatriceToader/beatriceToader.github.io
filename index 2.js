...
function update(){
    ...
    if (fbook) {
        ...
        //*
        fbook.position.clamp(new THREE.Vector3(-4.5, -2.25, -4), new THREE.Vector3(4.4, 3.7, 4));
        camera.position.clamp(new THREE.Vector3(-3.5, -1.2, -3), new THREE.Vector3(4, 5, 4.8));
